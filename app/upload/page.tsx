    ...
    <div className="flex flex-col min-h-screen bg-gray-200">
      <section className="flex-grow">
        ...
        <main className="flex items-center justify-center my-[40px] mt-40">
          <div className="bg-white p-8 rounded-lg flex flex-row justify-center items-center">
            {/* the picture */}
            <div>
              <img src="/RobotStudying.png" alt="guy i found on linkedin" className="w-[500px] h-[500px]"/>
            </div>
            ...
            <div className="flex flex-col items-center ml-[40px]">
              ...
              <div className="flex mb-10">
                <div className="border-2 border-gray-400 p-2 text-center px-24 cursor-pointer flex items-center">
                  <span className="mr-3 text-2xl">
                    <FaFileArrowUp />
                  </span> 
                  PDF, Docx, or text file
                </div>
                <button className="bg-blue-500 text-white font-bold px-6 py-3 hover:bg-blue-600 transition duration-300">Upload</button>
              </div>
              <div className="flex justify-start flex-col items-start w-full mb-10">
                <p>Save as</p>
                <input type="text" placeholder="File name" className=" border-2 border-gray-400 p-2 text-start w-full"/>
              </div>
              <div className="flex justify-between border-2 border-gray-400 mb-16">
                <div className="flex items-center border-r-2 border-gray-400 p-1 px-5">
                ...
                <div className="flex items-center border-gray-400 p-1 px-5">
                  <div className="w-6 h-6 border-2 border-gray-600 rounded-full p-1 mr-4"></div>
                  <p>Title</p>
                </div>
              </div>
              <button className="bg-blue-500 text-white font-bold rounded-md p-2 px-6 w-full hover:bg-blue-600 transition duration-300">Summarize</button>
            </div>
          </div>
        </main>
      </section>
