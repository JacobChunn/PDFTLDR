          ...
          <div className="bg-white p-8 rounded-lg flex flex-row justify-center items-center">
            ...
            <div className="flex flex-col items-center ml-[40px]">
              ...
              <div className="flex mb-10">
                <div className="bg-gray-400 border-b-2 border-gray-600 p-2 text-center px-24 cursor-pointer flex items-center"> 
              ...
              <div className="flex justify-start flex-col items-start w-full mb-10">
                <p>Save as</p>
                <input type="text" placeholder="Placeholder" className="bg-gray-400 border-b-2 border-gray-600 p-2 text-start w-full"/>
              </div>
