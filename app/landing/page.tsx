    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex">
        <div className="flex-1">
          <div className="h-screen [background:var(--color-background-grey)] flex flex-col items-center justify-center">
            <section className="text-center">
              ...
              <p className="[color:var(--color-dark-grey)]  mb-8 text-left max-w-[850px] ml-8 mr-8 text-lg">Welcome to PDF TL;DR, where we make things easier for you.
        ...
        <div className="flex-1">
          <div className="h-screen [background:var(--color-background-grey)] flex items-center justify-end">
            <img src="RobotClass.jpeg" alt="Placeholder" className="w-96 rounded-l-lg" style={{ objectPosition: 'center top', borderTopLeftRadius: '30px', borderBottomLeftRadius: '30px', width: '600px', boxShadow: '5px 5px 10px rgba(0, 0, 0, 0.5)' }}/>
          </div>
        </div>
      </div>
      ...
      <div className="[background:var(--color-grey)]">
        <div className="max-w-4xl mx-auto py-16 px-4 mt-4">
          <h2 className="[color:var(--color-white)] [font-family:var(--primary-font)] text-center text-6xl ">Streamline Your Reading</h2>
        </div>
          ...
          <div className="flex justify-center">
            <div className="w-full xl:w-2/4 mx-2 flex items-center relative">
              ...
              <div className="absolute top-1/2 transform -translate-y-1/2 left-20 ">
                ...
                <p className="[color:var(--color-dark-grey)] mx-auto text-md">Easily summarize .pdf, .docx, and more</p>
              </div>
              <div className="absolute top-1/2 transform -translate-y-1/2 left-2">
                <img src="File.png" alt="Placeholder" className="w-10 h-10 [background:var(--color-background-grey)] ml-2" />
              </div>
            </div>
            <div className="w-full xl:w-2/4 mx-2 flex items-center relative">
              <div className="w-full h-20 [background:var(--color-background-grey)] rounded-md"></div>
              <div className="absolute top-1/2 transform -translate-y-1/2 left-20">
                ...
                <p className="[color:var(--color-dark-grey)] mx-auto text-md">Tailor summary length to your liking</p>
              </div>
              <div className="absolute top-1/2 transform -translate-y-1/2 left-2">
                <img src="Gear.png" alt="Placeholder" className="w-10 h-10 [background:var(--color-background-grey)] ml-2" />
              </div>
            </div>
            <div className="w-full xl:w-2/4 mx-2 flex items-center relative">
              <div className="w-full h-20 [background:var(--color-background-grey)] rounded-md"></div>
              <div className="absolute top-1/2 transform -translate-y-1/2 left-20">
                ...
                <p className="[color:var(--color-dark-grey)] mx-auto text-md">View your saved summaries</p>
              </div>
              <div className="absolute top-1/2 transform -translate-y-1/2 left-2">
                <img src="24-7.png" alt="Placeholder" className="w-10 h-10 [background:var(--color-background-grey)] ml-2" />
              </div>
            </div>
          </div>
        </div>
